...
kpi_cols[0].metric("Total applications", f"{kpis['total_applications']:,}")
...
with chart_cols[1]:
    ...
    if education_area_df.empty:
        ...
        top_areas_df = education_area_df.head(20).set_index("utbildningsomrade")["total_applications"]
...
if applications_df.empty:
    ...
    visible_columns = [column for column in preferred_columns if column in applications_df.columns]
    st.dataframe(
...
with export_cols[1]:
    ...
    if st.button("Export Stats By Year CSV"):
